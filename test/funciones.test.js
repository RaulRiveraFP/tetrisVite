import { modificaNick } from '../src/funciones/modificaNick.js'
import { modificaData } from '../src/funciones/modificaData.js'
import { modificaData2 } from '../src/funciones/modificaData2.js'
import { dias } from '../src/funciones/dias.js'
...
describe('dias', () => {
  it('debería calcular los días transcurridos correctamente', () => {
    ...
    const resultado = dias('03/12/23T21:00:00'); 
